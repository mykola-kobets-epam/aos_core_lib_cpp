...
/**
 * Stub implementation of ImageInfoProviderItf interface
 */
...
public:
    ...
    /**
     * Sets service config for specific item and image.
     */
    ...
    /**
     * Sets image config for specific item and image.
     */
