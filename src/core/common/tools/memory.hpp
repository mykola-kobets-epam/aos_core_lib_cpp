...
{
    if (ptr) {
        static_cast<T*>(ptr)->~T(); // NOSONAR cpp:M23_329
...
private:
    void Dispose() override
    {
        ...
        this->~SharedObjectControlBlock(); // NOSONAR cpp:M23_329
        allocator.Free(this);
    }
...
private:
    void Dispose() override
    {
        ...
        this->~SharedAdoptControlBlock(); // NOSONAR cpp:M23_329
        allocator.Free(this);
    }
